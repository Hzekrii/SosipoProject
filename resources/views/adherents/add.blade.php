            ...
            <div class="col">
                <div class="card text-dark">
                    <div class="card-body">
                        ...
                        <form method="POST" class="needs-validation" novalidate="" action="{{ route('adherents.store') }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="nb_enfant" type="number" min="0" class="form-control" name="nb_enfant" value="{{ old('nb_enfant') }}" required>
                                @error('nb_enfant')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
