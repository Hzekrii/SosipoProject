            ...
            <div class="col">
                <div class="card text-dark">
                    <div class="card-body">
                        ...
                        <form method="POST" class="needs-validation" novalidate="" action="{{ route('depense.add') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input id="montant" type="text" class="form-control" name="montant"
                            ...
                            <div class="mb-3">
                                <label for="av" class="form-label">Rubrique</label>
                            ...
                            <div class="mb-3">
                                <label class="mb-2 text-muted" for="feuille">Feuille de depense</label>
