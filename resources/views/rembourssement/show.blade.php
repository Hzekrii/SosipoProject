                ...
                <table id="recettes-table" class="table rounded table-light table-striped-columns table-hover" style="font-size: 0.9em;">
                    @if (Auth::user()->role_id=="2")
                        <div class="d-flex justify-content-start ms-3 mt-3">
                            <a href="{{ route("rembourssement.add") }}" class="btn btn-success text-light"><i class="bi bi-plus-circle me-2"></i>Nouveau rembourssement</a>
                        </div>
                    @endif
                    <thead>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($rembourssement->approuve)
                                        {{"ACTIONS INTERDITS !"}}
                                    @else
                                        <a href="{{ route('rembourssement.edit',['id' => $rembourssement->id]) }}" class="btn btn-primary mx-1">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <button type="button" class="btn btn-danger mx-1" data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal{{ $rembourssement->id }}">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                            <div class="row justify-content-end">
                                                                ...
                                                                <div class="col-auto">
                                                                <form action="{{ route('rembourssement.delete', $rembourssement->id) }}"  method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
